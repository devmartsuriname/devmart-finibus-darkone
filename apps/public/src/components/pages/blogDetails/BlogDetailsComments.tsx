      ...
      <div className="blog-comments">
        ...
        <div className="single-comments">
          <div className="post-author">
            <img src="/images/comment-author-1.png" alt="blog comments images" />
          </div>
          <div className="post-author-details">
            ...
            <div className="reply">
              <Link to="#" onClick={scrollTop}>
                <img src="/images/icons/arrow-reply.svg" alt="blog comments images" />{" "}
                Reply
              </Link>
            </div>
          </div>
        ...
        <div className="single-comments">
          <div className="post-author">
            <img src="/images/comment-author-2.png" alt="blog comments images" />
          </div>
          <div className="post-author-details">
            <h4>Jhohan Doe</h4>
            <span>11 January, 2022 At 01.56 pm</span>
        ...
        <div className="single-comments">
          <div className="post-author">
            <img src="/images/comment-author-3.png" alt="blog comments images" />
          </div>
          <div className="post-author-details">
